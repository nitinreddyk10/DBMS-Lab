-- QuestiON 1
SELECT name FROM (SELECT * FROM professor WHERE empId IN (SELECT hod FROM department)) 
MINUS
SELECT name FROM (SELECT * FROM professor WHERE empId IN (SELECT hod FROM department)) 
WHERE startYear > ANY(SELECT startYear FROM professor WHERE empId IN (SELECT hod FROM department));
